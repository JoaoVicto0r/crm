...
export function TicketsContent() {
  ...
  const API_URL = "https://api-royal-production.up.railway.app" // sua API
  ...
  if (loading) return <p className="text-white">Carregando tickets...</p>

  return (
    <div className="space-y-6">
      {/* Mantém todo o JSX original: cards, filtros e tabela */}
      {/* Use filteredTickets no lugar do mockTickets */}
      {/* ...o restante do seu código JSX permanece igual */}
    </div>
  )
}
